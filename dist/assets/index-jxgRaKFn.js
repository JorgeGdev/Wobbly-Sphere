...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function el(){return new ai({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Pa(),fragmentShader:`
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function tl(){return new ai({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pa(),fragmentShader:`
...
`+x,m.vertexShader=o.getMaterialDefine()+m.vertexShader}m.uniforms=Ci(Ci({},m.uniforms),o.uniforms),o.uniforms=m.uniforms}catch(p){console.error(p)}};if(this.__csm.isAlreadyExtended){var h=this.onBeforeCompile;this.onBeforeCompile=function(f,m){h(f,m),u(f)}}else this.onBeforeCompile=u;this.needsUpdate=!0}},{key:"patchShader",value:function(i,s,a){var o=this,l=s,c=Ci(Ci({},this.getPatchMapForMaterial()),this.__csm.patchMap);Object.keys(c).forEach(function(f){Object.keys(c[f]).forEach(function(m){var v=q0[f],x=o.__csm.type;if(f==="*"||J0(i.main,f))if(!v||Array.isArray(v)&&v.includes(x)||v==="*")l=$0(l,m,c[f][m]);else throw new Error("CSM: ".concat(f," is not available in ").concat(x,". Shader cannot compile."))})}),l=l.replace("void main() {",`
      ...
      `));var u=this.__csm.isAlreadyExtended,h=l.includes("// CSM_END");return u&&h?l=nv(l,"// CSM_END",`
        ...
        `.concat(i.main,`
        // CSM_END
          `)),l=i.defines+l,l}},{key:"parseShader",value:function(i){if(i){var s=i.replace(/\/\*\*(.*?)\*\/|\/\/(.*?)\n/gm,""),a=A0(s),o=P0(a),l=o.map(function(h){return h.name}).indexOf("main"),c=Ql(a.slice(0,l>=0?o[l].outer[0]:void 0)),u=l>=0?this.getShaderFromIndex(a,o[l].body):"";return{defines:"",header:c,main:u}}}},{key:"getMaterialDefine",value:function(){var i=this.__csm.type;return i?"#define IS_".concat(i.toUpperCase(),`;
`):`#define IS_UNKNOWN;
`}},{key:"getPatchMapForMaterial",value:function(){switch(this.__csm.type){case"ShaderMaterial":return G0;default:return z0}}},{key:"getShaderFromIndex",value:function(i,s){return Ql(i.slice(s[0],s[1]))}}]),t}(Qt),nu=`uniform float uTime;\r
...
}`;function mv(r){const e=document.createElement("style");e.innerHTML=r;const t=document.querySelector("head link[rel=stylesheet], head style");t?document.head.insertBefore(e,t):document.head.appendChild(e)}let ic=!1;class za{constructor({parent:e,autoPlace:t=e===void 0,container:n,width:i,title:s="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:l=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!ic&&o&&(mv(pv),ic=!0),n?n.appendChild(this.domElement):t&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=a}add(e,t,n,i,s){if(Object(n)===n)return new dv(this,e,t,n);const a=e[t];switch(typeof a){case"number":return new hv(this,e,t,n,i,s);case"boolean":return new rv(this,e,t);case"string":return new fv(this,e,t);case"function":return new aa(this,e,t)}console.error(`gui.add failed
	property:`,t,`
	object:`,e,`
	value:`,a)}addColor(e,t,n=1){return new uv(this,e,t,n)}addFolder(e){const t=new za({parent:this,title:e});return this.root._closeFolders&&t.close(),t}load(e,t=!0){return e.controllers&&this.controllers.forEach(n=>{n instanceof aa||n._name in e.controllers&&n.load(e.controllers[n._name])}),t&&e.folders&&this.folders.forEach(n=>{n._title in e.folders&&n.load(e.folders[n._title])}),this}save(e=!0){const t={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof aa)){if(n._name in t.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);t.controllers[n._name]=n.save()}}),e&&this.folders.forEach(n=>{if(n._title in t.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);t.folders[n._title]=n.save()}),t}open(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(e){this._closed!==e&&(this._closed=e,this._callOnOpenClose(this))}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._setClosed(!e),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const t=this.$children.clientHeight;this.$children.style.height=t+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const i=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=i+"px"})}),this}title(e){return this._title=e,this.$title.textContent=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onOpenClose(e){return this._onOpenClose=e,this}_callOnOpenClose(e){this.parent&&this.parent._callOnOpenClose(e),this._onOpenClose!==void 0&&this._onOpenClose.call(this,e)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(t=>{e=e.concat(t.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(t=>{e=e.concat(t.foldersRecursive())}),e}}const Bt=new za({width:325}),Gn={},iu=document.querySelector("canvas.webgl"),li=new Ug,gv=new S_,ru=new r0;ru.setDecoderPath("./draco/");const su=new b_;su.setDRACOLoader(ru);gv.load("./urban_alley_01_1k.hdr",r=>{r.mapping=ns,li.background=r,li.environment=r});Gn.colorA="#1e00ff";Gn.colorB="#37d273";const tn={uTime:new $t(0),uPositionFrequency:new $t(.5),uTimeFrequency:new $t(.3),uStrength:new $t(.15),uWarpPositionFrequency:new $t(.38),uWarpTimeFrequency:new $t(.12),uWarpStrength:new $t(1.7),uColorA:new $t(new Ne(Gn.colorA)),uColorB:new $t(new Ne(Gn.colorB))},Ki=new tu({baseMaterial:un,vertexShader:nu,fragmentShader:iv,uniforms:tn,silent:!0,metalness:0,roughness:.5,color:"#ffffff",transmission:0,ior:1.5,thickness:1.5,transparent:!0,wireframe:!1}),_v=new tu({baseMaterial:Hc,vertexShader:nu,uniforms:tn,silent:!0,depthPacking:xc});Bt.add(tn.uPositionFrequency,"value").min(0).max(2).step(.001).name("Position Frequency");Bt.add(tn.uTimeFrequency,"value").min(0).max(2).step(.001).name("Time Frequency");Bt.add(tn.uStrength,"value").min(0).max(2).step(.001).name("Strenght");Bt.add(tn.uWarpPositionFrequency,"value").min(0).max(2).step(.001).name("Warp Position Frequency");Bt.add(tn.uWarpTimeFrequency,"value").min(0).max(2).step(.001).name("Warp Time Frequency");Bt.add(tn.uWarpStrength,"value").min(0).max(2).step(.001).name("Warp Strenght");Bt.addColor(Gn,"colorA").onChange(()=>{tn.uColorA.value.set(Gn.colorA)});Bt.addColor(Gn,"colorB").onChange(()=>{tn.uColorB.value.set(Gn.colorB)});Bt.add(Ki,"metalness",0,1,.001);Bt.add(Ki,"roughness",0,1,.001);Bt.add(Ki,"transmission",0,1,.001);Bt.add(Ki,"ior",0,10,.001);Bt.add(Ki,"thickness",0,10,.001);su.load("./suzanne.glb",r=>{r.scene.traverse(e=>{e.isMesh&&(e.material=Ki,e.receiveShadow=!0,e.castShadow=!0,e.customDepthMaterial=_v)}),li.add(r.scene),console.log(r)});const $i=new Ba("#ffffff",3);$i.castShadow=!0;$i.shadow.mapSize.set(1024,1024);$i.shadow.camera.far=15;$i.shadow.normalBias=.05;$i.position.set(.25,2,-2.25);const Zi=new Ba("#ffffff",3);Zi.castShadow=!0;Zi.shadow.mapSize.set(1024,1024);Zi.shadow.camera.far=15;Zi.shadow.normalBias=.05;Zi.position.set(.115,-1.345,2.386);li.add($i);li.add(Zi);const Ft={width:window.innerWidth,height:window.innerHeight,pixelRatio:Math.min(window.devicePixelRatio,2)};window.addEventListener("resize",()=>{Ft.width=window.innerWidth,Ft.height=window.innerHeight,Ft.pixelRatio=Math.min(window.devicePixelRatio,2),Xi.aspect=Ft.width/Ft.height,Xi.updateProjectionMatrix(),Tn.setSize(Ft.width,Ft.height),Tn.setPixelRatio(Ft.pixelRatio)});const Xi=new Ct(35,Ft.width/Ft.height,.1,100);Xi.position.set(13,-3,-6);li.add(Xi);const au=new E_(Xi,iu);au.enableDamping=!0;const Tn=new zc({canvas:iu,antialias:!0});Tn.shadowMap.enabled=!0;Tn.shadowMap.type=sc;Tn.toneMapping=oc;Tn.toneMappingExposure=1;Tn.setSize(Ft.width,Ft.height);Tn.setPixelRatio(Ft.pixelRatio);const vv=new h_,ou=()=>{const r=vv.getElapsedTime();tn.uTime.value=r,au.update(),Tn.render(li,Xi),window.requestAnimationFrame(ou)};ou();
//# sourceMappingURL=index-jxgRaKFn.js.map
